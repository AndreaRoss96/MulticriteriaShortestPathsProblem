...
\graphicspath{ {img/} }
%COSE DA SCRIVERE:
% Spiegare come sono fatti i nodi
% dire che da nodo a nodo sono presenti più archi -> spiega i grafi
% guarda pagina 5 di "Speeding up martin's algorithm.."
% bicriteria figo perché puoi fare threading
% aggiungi references
%
\usepackage{amsmath}
