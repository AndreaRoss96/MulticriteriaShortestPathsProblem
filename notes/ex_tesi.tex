...
Poiché questo algoritmo ha alla base la formula dell'inviluppo convesso, significa che i risultati trovati andranno a creare la curva che rappresenta proprio l'inviluppo convesso.
...
Dove possibile sono statiutilizzate le stesse mappe e gli stessi punti utilizzati nellanalisi dei risultati del capitolo precedente, in questo modo è possibile fare anche un confronto con gli algoritmi mono-criteria riguardo ai nodi visitati ed ai percorsi trovati.
...
\begin{figure}[H]
	...
	\end{minipage}
	Source: 5221 $\to$ Target: 72\\Map: Cesena (Comune) \\ particolare
